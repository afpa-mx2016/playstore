...
require_once(dirname(__FILE__).'/../entities/PlayList.class.php');
require_once(dirname(__FILE__).'/../entities/Track.class.php');

use \PlayStore\Model\Entities\PlayList as PlayList;
